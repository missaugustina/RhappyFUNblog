...
![All the Things! Image: Steph de Silva [^1]](img/value_of_work.jpg)


![All the Things, Prioritized! Image: Julia Silge ](img/value_of_work_2.png)
...
![image: R-Ladies Remote [^2]](img/rladies-remote-why-remote.jpg)
 ...
 * [Twitch](https://www.twitch.tv/) is more well-known in the video game world, but IBM has had some success using it for live streaming. I was the guinea pig for a [video series](https://www.twitch.tv/ibmcode) our Open Source Advocacy folks are developing. [^3]
...
[^1]: [@StephdeSilva](https://twitter.com/StephdeSilva)
[^2]: [R-Ladies Remote "Why R-Ladies Remote?"](https://twitter.com/RLadiesRemote/status/988580783261564928)
[^3]: The video seems to have disappeared! I'll update once I find out where they archived it!
