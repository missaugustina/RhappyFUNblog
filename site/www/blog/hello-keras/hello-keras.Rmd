...
The MNIST (Modified National Institute of Standards and Technology) is a collection of handwritten, single-digit numbers. To learn more, [read the Wikipedia entry](https://en.wikipedia.org/wiki/MNIST_database).
 ...
 * [Erin & Gabi's Intro to Machine Learning Course on DataCamp](https://www.datacamp.com/courses/machine-learning-with-tree-based-models-in-r)
 * [Fast.ai Courses, note: these are taught in Python](https://www.fast.ai/)
