...
Her avid virtual viewers got to soak up her comprehensive insights on company cultures that work particularly well for remote working and strategies for challenges remote workers often face. 

> "If one person in a meeting is remote, everyone is remote." Julia Silge

One nugget that really hit home for me was the value of work continuum. Daydreamers like myself have a million and one ideas kicking around in our noggins. While there is value in the creative process, [better an egg today than a hen tomorrow](https://twitter.com/hashtag/rchickenladies).

![image: @Nujcharee https://twitter.com/Nujcharee](img/value_of_work.jpg)

While this continuum applies to pretty much every hare-brained idea, the particular challenge remote workers face is lack of instant feedback one gets in an immersive office environment.

> What of what we do matters the most? 

Which leads us to the more meta-topic, how do remote workers connect to each other?

## The Social Connection

Bonding with your coworkers and a community is very challenging when your only interactions are work time. While some solutions exist, like a virtual (insert-beverage-of-choice-here) chat or periodic in-person on-sites, connecting with the community beyond your workplace is another challenge.

The R-Ladies Remote chapter was officially announced in February of 2018 in response to the number of R-Ladies that either didn't have access to a strong local community or were unable to make regular R-Ladies chapter meetings near them. I joined because it was an opportunity to connect with many R-Ladies I meet from around the world!
...
At IBM, even though many people traditionally work from an office, we are so geographically spread out, we have to every meeting as a remote meeting. Additionally, R users are often buried in areas no one would expect (well, except for R users).

Last year, we created a virtual community called the R guild. We started an internal Slack channel where people could connect. We've hosted meetings through video chats and are still experimenting with format and meeting rotation. People's schedules and timezones complicate things. However, for people who were able to attend, it's been worth it. 

Going forward, we've been exploring other options that support asynchronous interactions like a forum and periodic R code challenges. The group is still gaining momentum but it's been a great resource for connecting R users across the many-headed hydra known as IBM.

## Other Remote R Groups Worth Considering

If you don't fall into the "lady and/or non-binary" category but would like to join a remote community, I would recommend the [R4DS online learning community](https://www.jessemaegan.com/post/r4ds-the-next-iteration/) started by Jesse Maegan in 2017. Jesse started the community as a way to connect with others who were learning R using the book [R for Data Science](http://r4ds.had.co.nz/).
...
[Twitch](https://www.twitch.tv/) is more well-known in the video game world, but IBM has had some success using it for live streaming. [I was the guinea pig for a new video podcast our Open Source Advocacy are developing.](https://www.twitch.tv/videos/252480943?t=8m)
...
I'm a huge fan of remote, especially as a researcher. However, it's still important to connect to communities in the flesh. If there aren't enough users of a particular language or technology in your area, find a more general topic or format people may be open to gathering on. For instance, my buddy [Genehack](http://genehack.net), longing for the physical company of other Perl users, formed a general purpose "interpreted languages" user group in Salem, OR. 

If the reason you don't attend meetings is due to schedule issues, consider hosting events at a time that works better for you. These don't have to be formal presentation style! 
