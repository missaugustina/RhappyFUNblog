...
# Countering Bean Counting: Open Source Influence Beyond Commits
...
![An example of a user profile on Github](../../static/post/2018-02-22-countering-bean-counting-commits_files/github_social_network_for_code.png)
...
![Github's The State of the Octoverse Report](../../static/post/2018-02-22-countering-bean-counting-commits_files/github_octoverse.png)
...
![A repository page featuring numbers of commits and contributors - Can you make a meaningful sentence out of this?](../../static/post/2018-02-22-countering-bean-counting-commits_files/make_a_sentence_1.png)


![The Insights page for a Github repository - What meaningful questions does (or even can) this answer?](../../static/post/2018-02-22-countering-bean-counting-commits_files/make_a_sentence_2.png)
...
author_summary <- readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_author_summary.Rds")
...
# From http://rpubs.com/auggy/tensorflow-committers

tf_google_email_nodes <- 
  readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_google_email_nodes.Rds")
tf_google_email_edges <- 
  readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_google_email_edges.Rds")
...
![A graph of email addresses used by identified Googlers in the Tensorflow project](../../static/post/2018-02-22-countering-bean-counting-commits_files/gh_emails_graph.png)

[Interactive graph available here]("../../static/post/2018-02-22-countering-bean-counting-commits_files/gh_emails_graph.html")
...
# From http://rpubs.com/auggy/tensorflow-commits

author_summary_network <- readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_author_summary_network.Rds")
...
committers_month <- readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/committer_month_network.Rds")
...
author_commits_month <- 
  readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_author_commits_month.Rds")
...
author_commits_qtr <- 
  readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_author_commits_qtr.Rds")
...
When plotted as a time series, the Commit Intervals illustrated above can also show us how long the organization has been engaged.
...
The IBM Cognitive Open Technology team recently hosted a Tensorflow panel at the conference Index that featured several key Tensorflow Googlers [https://developer.ibm.com/opentech/2018/02/03/index-feb-20-ai-open-community-gathering-featuring-tensorflow/]. The claim was made that Google was working to diversify the Tensorflow community by increasing non-Google committers.
...
committer_diversity <- readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_committer_diversity.Rds")
...
commit_diversity <- readRDS("../../static/post/2018-02-22-countering-bean-counting-commits_files/tf_commit_diversity.Rds")
